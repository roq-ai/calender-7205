...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Days', path: '/days', entity: 'day', service: AccessServiceEnum.PROJECT, icon: FiSun },
    { name: 'Meetings', path: '/meetings', entity: 'meeting', service: AccessServiceEnum.PROJECT, icon: FiMic },
