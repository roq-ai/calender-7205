  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Calender - Your Personalized Scheduler. Tailor your year, plan your days, and manage your meetings with ease and precision."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1435527173128-983b87201f4d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjYWxlbmRhcnxlbnwwfHx8fDE2OTA5MTU3NjB8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@erothermel?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Eric Rothermel`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Calender - Your Personalized Scheduler. Tailor your year, plan your days, and manage your meetings with ease and precision.`}
            </Text>
            <Box
